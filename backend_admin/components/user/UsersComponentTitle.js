...
const UsersComponentTitle = ({title, titleDescription, buttonTitle}) => {
    ...
    return (
        ...
        <div className="flex flex-wrap items-start justify-end -mb-3">
          ...
          >
            ...
            <Modal modal={modal} setModal={setModal} inputStatus="createUser"/>
        </div>
      </>
    );
};

export default UsersComponentTitle;